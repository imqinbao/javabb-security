...
public class OperLogAspect {
    ...
    @Pointcut("@annotation(cn.javabb.common.annotation.OperLog)")
    public void operLog() {
    }
    ...
    private void saveLog(JoinPoint joinPoint, Object result, Exception e) {
        ...
        // 构建操作日志
        OperRecordDO operRecord = new OperRecordDO();
    ...
    private Integer getLoginUserId() {
        ...
        if (object instanceof UserDO) return ((UserDO) object).getUserId();
        return null;
    }

...
public class DictionaryDataController extends BaseController {
    ...
    @ApiPageParam
    @GetMapping("/page")
    public PageResult<DictionaryDataDO> page(HttpServletRequest request) {
        PageParam<DictionaryDataDO> pageParam = new PageParam<>(request);
    ...
    public JsonResult list(HttpServletRequest request) {
        PageParam<DictionaryDataDO> pageParam = new PageParam<>(request);
        List<DictionaryDataDO> records = dictionaryDataService.listAll(pageParam.getNoPageParam());
    ...
    @ApiOperation("添加字典项")
    @PostMapping()
    public JsonResult add(@RequestBody DictionaryDataDO dictionaryData) {
        if (dictionaryDataService.count(new QueryWrapper<DictionaryDataDO>()
    ...
    @ApiOperation("修改字典项")
    @PutMapping()
    public JsonResult update(@RequestBody DictionaryDataDO dictionaryData) {
        if (dictionaryDataService.count(new QueryWrapper<DictionaryDataDO>()
                .eq("dict_id", dictionaryData.getDictId())
    ...
    @PostMapping("/batch")
    public JsonResult saveBatch(@RequestBody List<DictionaryDataDO> dictDataList) {
